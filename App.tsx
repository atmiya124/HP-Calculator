...
import FloatingMenu, { MenuTab } from './components/FloatingMenu';
...
function AppContent() {
  const [activeTab, setActiveTab] = useState<MenuTab>('led');
  ...
  const getSummaryText = useCallback(() => {
    if (activeTab !== 'led' || !result) return '';
    return [
  ...
  return (
    ...
    <View style={styles.root} onLayout={onLayoutRootView}>
      ...
      <Header getSummaryText={getSummaryText} />
      <FloatingMenu active={activeTab} onSelect={setActiveTab} />
    </View>
    </View>
  );
}
